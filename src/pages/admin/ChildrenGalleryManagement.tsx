...
const ChildrenGalleryManagement = () => {
  const [galleryImages, setGalleryImages] = useState<ChildrenGallery[]>([]);
  ...
  const toggleImageStatus = async (image: ChildrenGallery) => {
    try {
      const { error } = await supabase
        .from('children_gallery')
  ...
  const deleteImage = async (image: ChildrenGallery) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Children Home Gallery Management</h1>
                <p className="text-sm text-gray-600">Manage children home gallery images</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {uploading ? 'Uploading Images...' : 'Upload Children Home Gallery Images'}
              </h3>
            ...
            {galleryImages.map((image, index) => (
              <div key={image.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                <div className="relative group">
                  <img
                    src={image.image_url}
                    alt={`Children gallery image ${index + 1}`}
        ...
        {galleryImages.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Children Gallery Images Yet</h3>
            <p className="text-gray-600 mb-6">Upload your first images to get started with the children home gallery.</p>
          </div>
        )}
...
export default ChildrenGalleryManagement;