...
const ReliefGalleryManagement = () => {
  const [galleryImages, setGalleryImages] = useState<ReliefGallery[]>([]);
  ...
  const toggleImageStatus = async (image: ReliefGallery) => {
    try {
      const { error } = await supabase
        .from('relief_gallery')
  ...
  const deleteImage = async (image: ReliefGallery) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Relief Gallery Management</h1>
                <p className="text-sm text-gray-600">Manage relief program gallery images</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {galleryImages.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Upload your first images to get started with the relief gallery.</p>
          </div>
        )}
...
export default ReliefGalleryManagement;